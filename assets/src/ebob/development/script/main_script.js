$(document).ready(function(){
	...
	var handleBarChart = function (companyId) {
		"use strict";
		$.ajax({
			type:'POST',
	...
	$('#companyDD').change(function(){
		...
		$.ajax({
			...
			success: function(data) {
				...
				handleDonutChart(pendingComplains, resolvedComplains, $("#filterDD").val());
				handleDonutChart(pendingComplains, resolvedComplains, $('#cityRegionFilter').val());
				handleBarChart($('#companyDD').val());
			},
			error:function(jqXHR,textStatus,errorThrown ){
				alert('Exception:'+errorThrown );
