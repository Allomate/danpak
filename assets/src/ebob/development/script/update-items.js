  ...
  $(document).on('click',".viewItemDetails",function(){
    ...
    ajaxer('getItemData.php', ajaxData, function(response){
      ...
      if (response.image != '' && response.image != null) {
        $('#prodImgs').append("<div class='col-md-5'><article><header><img src='"+response.image+"' width='100%' height='auto'></header><content><center><span class='deleteImgSpan' id='"+response.image+"'>DELETE</span></center></content></article></div>");
      }
