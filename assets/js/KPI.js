$(document).ready(function() {
    ...
    var monthDisablerCounter = 0;
    var currDate = new Date();
    var currMonth = currDate.getMonth();

    // $('select[name="monthDD"] option').each(function() {
    //     if (monthDisablerCounter < currMonth) {
    //         $(this).remove();
    //     }
    //     monthDisablerCounter++;
    // });

    // if (currMonth == "3" || currMonth == "4" || currMonth == "5") {
    //     $('select[name="quarterDD"] option[value="q1"]').remove();
    // } else if (currMonth == "6" || currMonth == "7" || currMonth == "8") {
    //     $('select[name="quarterDD"] option[value="q1"]').remove();
    //     $('select[name="quarterDD"] option[value="q2"]').remove();
    // } else if (currMonth == "9" || currMonth == "10" || currMonth == "11") {
    //     $('select[name="quarterDD"] option[value="q1"]').remove();
    //     $('select[name="quarterDD"] option[value="q2"]').remove();
    //     $('select[name="quarterDD"] option[value="q3"]').remove();
    // }
