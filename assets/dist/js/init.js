...
var jetson = function() {
    ...
    $(document).on('click', '#open_right_sidebar', function(e) {
        if (this.classList[0] == "Dashboardv1") {
            $('.pro-header-text2').html('<h3>Dashboard</h3>');
            $('.plist-content2 ._dash-links').hide();
            $('.plist-content2 #dashLinks').show();
        } else if (this.classList[0] == "Organization") {
            $('.pro-header-text2').html('<h3>Organization Management</h3>');
            $('.plist-content2 ._dash-links').hide();
            $('.plist-content2 #orgLinks').show();
        } else if (this.classList[0] == "ListEmployees") {
            $('.pro-header-text2').html('<h3>Sales Force Management</h3>');
            $('.plist-content2 ._dash-links').hide();
            $('.plist-content2 #sfm').show();
        } else if (this.classList[0] == "ListInventory") {
            $('.pro-header-text2').html('<h3>Inventory Management</h3>');
            $('.plist-content2 ._dash-links').hide();
            $('.plist-content2 #invm').show();
        } else if (this.classList[0] == "ViewCatalogues") {
            $('.pro-header-text2').html('<h3>Catalogue Management</h3>');
            $('.plist-content2 ._dash-links').hide();
            $('.plist-content2 #catalogue').show();
        } else if (this.classList[0] == "ListRetailers") {
            $('.pro-header-text2').html('<h3>Retailers Management</h3>');
            $('.plist-content2 ._dash-links').hide();
            $('.plist-content2 #retailers').show();
        } else if (this.classList[0] == "ListPrimOrders") {
            $('.pro-header-text2').html('<h3>Primary Orders Management</h3>');
            $('.plist-content2 ._dash-links').hide();
            $('.plist-content2 #primOrds').show();
        } else if (this.classList[0] == "ListMessages") {
            $('.pro-header-text2').html('<h3>Bulletins Management</h3>');
            $('.plist-content2 ._dash-links').hide();
            $('.plist-content2 #bulletins').show();
        } else if (this.classList[0] == "Reports") {
            $('.pro-header-text2').html('<h3>Reports</h3>');
            $('.plist-content2 ._dash-links').hide();
            $('.plist-content2 #dashLinks').show();
        }
