								...
								<table class="table table-hover display  pb-30">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="<?= base_url('RealRetailers/UpdateRetailersAssignments/'.$assignment->employee_id.'/'.$assignment->assigned_for_day); ?>">
													<i class="fa fa-pencil"></i>
												</a>
												&nbsp;
												<a class="deleteConfirmation" href="<?= base_url('RealRetailers/DeleteRetailersAssignments/'.$assignment->employee_id.'/'.$assignment->assigned_for_day); ?>">
		...
		$(document).on('click', '.viewCompleteDistributorsList', function () {
			...
			$.ajax({
				...
				success: function (response) {
					...
					$('.modal-body').html(
						'<table class="table" id="distributorsDetailsTable"><thead><tr><th>Name</th><th>Address</th><th>Territory</th></tr></thead><tfoot><tr><th>Name</th><th>Address</th><th>Territory</th></tr></tfoot><tbody>'
					);
					for (var i = 0; i < response.length; i++) {
						$('#distributorsDetailsTable tbody').append('<tr><td>' + response[i].retailer_name + '</td><td>' +
							response[i].retailer_address + '</td><td>' + response[i].territory_name + '</td></tr>');
					}
