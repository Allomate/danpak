			...
			<div class="row heading-bg">
				...
				<div class="col-lg-6 col-md-6">
					<ol class="breadcrumb">
						...
						<li><span>Retailers Management</span></li>
					</ol>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="box-white p-20"><a href="<?= base_url('RealRetailers/AddMoreAssignments');?>" class="btn add-emp"><i class="fa fa-plus"> </i> New Assignments</a>
								...
								<table class="table table-hover display  pb-30" >
									...
									<tbody>
										...
										<tr>
											...
											<td><?= $assignment->total_distributors_assigned; ?> <small class="viewCompleteDistributorsList" id="<?= $assignment->employee_id; ?>" style="font-weight: bold; cursor: pointer;">(VIEW)</small> </td>
											<td><?= $assignment->territory_name; ?></td>
											<td>
												<a href="<?= base_url('RealRetailers/UpdateRetailersAssignments/'.$assignment->employee_id); ?>"><i class="fa fa-pencil"></i></a>
												&nbsp;
												<a class="deleteConfirmation" href="<?= base_url('RealRetailers/DeleteRetailersAssignments/'.$assignment->employee_id); ?>"><i class="fa fa-close"></i></a>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
...
<input type="text" value="<?= base_url('RealRetailers/ViewCompleteRetailersListForAnEmployeeAjaxRequest'); ?>" id="getRetailersList">
</div>
