		...
		<div class="container-fluid">
			...
			<div class="row heading-bg">
				<div class="col-lg-6 col-md-6 col-sm-6">
					<h2 class="m-heading">Retailer Types Management</h2>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6">
					<ol class="breadcrumb">

						<li><a href="#"><span>Organization</span></a></li>
						<li><span>Retailer Types Management</span></li>
					</ol>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="box-white p-20"><a href="<?= base_url('RealRetailers/AddRetailerType');?>" class="btn add-emp"><i class="fa fa-plus"> </i> New Retailer Type</a>
						<h2 class="m-b-0 less_600">Retailer Types List </h2>
								...
								<table  class="table table-hover display  pb-30" >
									...
									<tbody>
										...
										<tr>
											...
											<td><?= $type->discount; ?></td>
											<td>
												<a href="<?= base_url('RealRetailers/UpdateRetailerType/'.$type->id); ?>"><i class="fa fa-pencil"></i></a>
												&nbsp;
												<a class="deleteConfirmation" href="<?= base_url('RealRetailers/DeleteRetailerType/'.$type->id); ?>"><i class="fa fa-close"></i></a>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
