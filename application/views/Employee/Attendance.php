									...
									<div class="container-fluid">
										<div class="row">
											<div class="col-xs-8 text-center pl-0 pr-0 data-wrap-left">
												<span class="txt-dark block counter"><?= $AttendanceStats["present_today"]; ?></span>
							...
							<div class="panel-body pa-0">
								<div class="sm-data-box">
									<div class="container-fluid">
										<div class="row">
											<div class="col-xs-8 text-center pl-0 pr-0 data-wrap-left">
												<span class="txt-dark block counter"><?= $AttendanceStats["absent_today"]; ?></span>
												<span class="weight-500 uppercase-font block">Absent Today</span>
											</div>
											<div class="col-xs-4 text-center  pl-0 pr-0">
							...
							<div class="panel-body pa-0">
								<div class="sm-data-box">
									<div class="container-fluid">
										<div class="row">
											<div class="col-xs-8 text-center pl-0 pr-0 data-wrap-left">
												<span class="txt-dark block counter"><?= $AttendanceStats["location_compliance"]; ?></span>
												<span class="weight-500 uppercase-font block font-13">Location Compliance</span>
											</div>
											<div class="col-xs-4 text-center  pl-0 pr-0">
							...
							<div class="panel-body pa-0">
								<div class="sm-data-box">
									<div class="container-fluid">
										<div class="row">
											<div class="col-xs-8 text-center pl-0 pr-0 data-wrap-left">
												<span class="txt-dark block counter"><?= $AttendanceStats["none_compliance"]; ?></span>
												<span class="weight-500 uppercase-font block font-13">None Compliance</span>
											</div>
											<div class="col-xs-4 text-center  pl-0 pr-0">
							...
							<div class="table-responsive">
								<table class="table table-hover display  pb-30" >
									...
									<tbody>
										...
										<tr>
											<td><?= $data["date"]; ?></td>
											<td><?= $data["data"][$i]->employee_name; ?></td>
											<td><?= $data["data"][$i]->employee_name; ?></td>
											<td><?= $data["data"][$i]->region; ?></td>
											<td><?= $data["data"][$i]->area; ?></td>
											<td><?= $data["data"][$i]->territory; ?></td>
											<td><?= $data["data"][$i]->check_in_time; ?></td>
											<td><?= $data["data"][$i]->check_out_time; ?></td>
											<td><?= $data["data"][$i]->within_radius; ?></td>
											<td>
												<?php if($data["data"][$i]->check_in_time != "Not checked in") : ?>
													...
													<input type="text" id="empBaseLongs" value="<?= $data["data"][$i]->employee_base_station_longs; ?>" hidden>
...
<script>
	...
	function initMap(lats, longs, baseLats, baseLongs, baseStation, attendaceLocation) {
		var uluru = {lat: parseFloat(lats), lng: parseFloat(longs)};
