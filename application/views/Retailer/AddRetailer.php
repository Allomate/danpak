								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="distributor_username" class="form-control" value="<?=set_value('distributor_username');?>">
								...
								<div class="row">
									...
									<!-- <div class="col-md-4">
										<div class="form-group">
											...
											<div style="width: 100%">
												<select style="width: 85%; display: inline-block" class="form-control" name="orderBooker" data-style="form-control btn-default btn-outline">
													<option value="0">Select O.B</option>
												</select>
												<span id="addOb" style="cursor: pointer; width: 10%;display: inline-block;padding-top: 8px;padding-bottom: 8px;text-align: center;background: #001e35;color: white;font-weight: bold;box-shadow: 0 2px 8px 0 #e5d6d6;">+</span>
											</div>
										</div>
									</div> -->
								</div>
