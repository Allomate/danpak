...
<div class="wrapper theme-1-active">
	...
	<div class="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box-white p-20"><a href="<?= base_url('Retailers/AddRetailer');?>" class="btn add-emp"><i class="fa fa-plus"> </i> New Distributor</a>
									...
									<tbody>
										<?php foreach ($Distributors as $retailer) : ?>
											<tr>
												...
												<td>
													<a href="<?= base_url('Retailers/UpdateRetailer/'.$retailer->id); ?>"><i class="fa fa-pencil"></i></a>
													&nbsp;
													<a class="deleteConfirmation" href="<?= base_url('Retailers/DeleteRetailer/'.$retailer->id); ?>"><i class="fa fa-close"></i></a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
