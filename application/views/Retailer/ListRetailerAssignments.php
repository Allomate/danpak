								...
								<table class="table table-hover display  pb-30">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="<?= base_url('Retailers/UpdateRetailersAssignments/'.$assignment->employee_id.'/'.$assignment->assigned_for_day); ?>">
													<i class="fa fa-pencil"></i>
												</a>
												&nbsp;
												<a class="deleteConfirmation" href="<?= base_url('Retailers/DeleteRetailersAssignments/'.$assignment->employee_id.'/'.$assignment->assigned_for_day); ?>">
