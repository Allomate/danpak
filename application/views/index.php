			...
			<div class="row">
				<div class="col-md-12 m-t-30">
					...
					<a href="<?= base_url('Employees/ListEmployees'); ?>">
						<div class="col-md-4">
							<div class="box-sec">
								<span class="img-svg"><img src="<?= base_url('assets/images/sale-icon-home.svg'); ?>" alt=""/></span>
					...
					<a href="<?= base_url('Bulletins/ListMessages'); ?>">
						<div class="col-md-4">
							<div class="box-sec">
								<span class="img-svg"><img src="<?= base_url('assets/images/bulletins-icon-home.svg'); ?>" alt=""/></span>
					...
					<a href="<?= base_url('Dashboard/Reports'); ?>">
						<div class="col-md-4">
							<div class="box-sec">
								<span class="img-svg"><img src="<?= base_url('assets/images/reports-icon-home.svg'); ?>" alt=""/></span>
