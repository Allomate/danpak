	...
	<div class="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row">
				...
				echo form_open('PrimaryOrders/UpdateOrderOps/'.$Order->id, $attributes);
							...
							<div class="table-responsive">
								<table class="table table-hover display stockOrderTable pb-30">
									...
									<tfoot>
										<tr>
											<th>
												<a href="<?= base_url('PrimaryOrders/ListOrders'); ?>" type="button" class="btn btn-cancel">Cancel</a>
											</th>
											<th>Item</th>
											<th>Unit Type</th>
											<th>Unit Price</th>
			...
			echo form_open('PrimaryOrders/ExpandOrderOps/'.$Order->id, $attributes);
