								...
								<table class="table table-hover display pb-30">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="<?= base_url('PrimaryOrders/ListOrdersIndividual/'.$order['employee_id'].'/'.urlencode($order['date']).'/'.$this->uri->segment(3)); ?>">
													<button class="btn view-report">View Orders List</button>
												</a>
												<?php if($this->uri->segment(3) == "Latest" || $this->uri->segment(3) == "Pending") : ?>
												<a href="<?= base_url('PrimaryOrders/BookingSheet/'.$order['employee_id'].'/'.urlencode($order['date']).'/'.$this->uri->segment(3)); ?>">
													<button class="btn view-report">Load Sheet</button>
												</a>
												<!-- <a href="<?= base_url('PrimaryOrders/DeliveryChallan/'.$order['employee_id'].'/'.urlencode($order['date']).'/'.$this->uri->segment(3)); ?>">
