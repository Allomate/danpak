			...
			<div class="row">
				<div class="col-md-12">
					<div class="box-white m-b-30">
						...
						echo form_open('PrimaryOrders/CreateManualOrders', $attributes); 
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="row">
											...
											<div class="col-md-6">
												<label class="control-label mb-10">Freight Charges</label>
												<input type="number" name="freight_charges" min="0" value="0" class="form-control">
											</div>
										</div>
									</div>
								</div>
...
<input type="text" value="<?= base_url('PrimaryOrders/GetUnitsForSku'); ?>" id="getItemsForSku" hidden>
<?php require_once(APPPATH.'/views/includes/footer.php'); ?>
<script type="text/javascript" src="<?= base_url('assets/js/PrimaryOrders.js').'?v='.time(); ?>"></script>
