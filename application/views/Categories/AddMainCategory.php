...
<div class="wrapper theme-1-active">
	...
	<div class="page-wrapper">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box-white m-b-30">
						...
						<?php $attributes = array('id' => 'addMainCategoryForm');
						echo form_open('Categories/AddMainCategoryOps/', $attributes); ?>
						<div class="form-wrap">
							<div class="form-body">
								<div class="row"> 
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" name="main_category_name" class="form-control" value="<?= set_value('main_category_name'); ?>">
		...
		<div class="row button-section">
			<a type="button" href="<?= base_url('Categories/ListMainCategories'); ?>" id="backFromAddMainCategories" class="btn btn-cancel">Cancel</a>
			<a type="button" id="addMainCatButton" class="btn btn-save">Save</a>						
		</div>
	</div>
</div>
</div>
