...
<div class="wrapper theme-1-active">
	...
	<div class="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box-white p-20"><a href="<?= base_url('Regions/AddRegion');?>" class="btn add-emp"><i class="fa fa-plus"> </i> New Region</a>
									...
									<tbody>
										<?php foreach ($Regions as $region) : ?>
											<tr>
												...
												<td><?= $region->region_poc; ?></td>
												<td>
													<a href="<?= base_url('Regions/UpdateRegion/'.$region->id); ?>"><i class="fa fa-pencil"></i></a>
													&nbsp;
													<a class="deleteConfirmation" href="<?= base_url('Regions/DeleteRegion/'.$region->id); ?>" class="deleteConfirmation" ><i class="fa fa-close"></i></a>
