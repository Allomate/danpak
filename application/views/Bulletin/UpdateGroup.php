...
<div class="wrapper theme-1-active">
	...
	<div class="page-wrapper">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box-white m-b-30">
						<h2>Update Group</h2>
						<?php $attributes = array('id' => 'updateGroupForm');
						echo form_open('Bulletins/UpdateGroupOps/'.$group->id, $attributes);
						echo form_hidden('employee_id', $group->employee_id); ?>
						<div class="form-wrap">
							<div class="form-body">
								<div class="row"> 
									<div class="col-md-6">
		...
		<div class="row button-section">
			...
			<a type="button" id="updateGroupBtn" class="btn btn-save">Save</a>						
		</div>
	</div>
</div>
</div>
