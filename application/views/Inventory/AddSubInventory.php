...
<div class="wrapper theme-1-active">
	...
	<div class="page-wrapper">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box-white m-b-30">
						<h2>Add Sub-Inventory</h2>
						<?php $attributes = array('id' => 'addSubInventForm');
						echo form_open('Inventory/AddSubInventoryOps/', $attributes); 
		...
		<div class="row button-section">
			...
			<a type="button" id="addSubInventoryButton" class="btn btn-save">Save</a>						
		</div>
	</div>
</div>
</div>
