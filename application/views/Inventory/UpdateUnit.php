...
<div class="wrapper theme-1-active">
	...
	<div class="page-wrapper">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box-white m-b-30">
						...
						<?php $attributes = array('id' => 'updateUnitForm');
								...
								<div class="row"> 
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" name="unit_name" class="form-control" value="<?= $UnitType->unit_name; ?>">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" name="unit_short_name" class="form-control" value="<?= $UnitType->unit_short_name; ?>">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" name="unit_plural_name" class="form-control" value="<?= $UnitType->unit_plural_name; ?>">
		...
		<div class="row button-section">
			...
			<a type="button" id="updateUnitButton" class="btn btn-save">Save</a>						
		</div>
	</div>
</div>
</div>
