...
<div class="wrapper theme-1-active">
	...
	<div class="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box-white p-20"><a href="<?= base_url('Inventory/AddSubInventory');?>" class="btn add-emp"><i class="fa fa-plus"> </i> New Sub-Inventory</a>
						<h2 class="m-b-0 less_600">Sub-Inventory List </h2>
								...
								<table  class="table table-hover display  pb-30" >
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="<?= base_url('Inventory/UpdateSubInventory/'.$inventory->id); ?>"><i class="fa fa-pencil"></i></a>
												&nbsp;
												<a href="<?= base_url('Inventory/ConvertTo/'.$inventory->id); ?>">
													<button class="btn view-report">Convert</button>
												</a>
												&nbsp;
												<a class="deleteConfirmation" href="<?= base_url('Inventory/DeleteSubInventory/'.$inventory->id); ?>"><i class="fa fa-close"></i></a>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
