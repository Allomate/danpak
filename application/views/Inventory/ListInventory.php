...
<div class="wrapper theme-1-active">
	...
	<div class="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box-white p-20"><a href="<?= base_url('Inventory/AddInventory');?>" class="btn add-emp"><i class="fa fa-plus"> </i> New Item</a>
									...
									<tbody>
										<?php $sno = 1; foreach ($inventoryListSku as $inventory) : ?>
											<tr>
												...
												<td>
													<a href="<?= base_url('Inventory/UpdateInventorySku/'.$inventory->item_id); ?>"><i class="fa fa-pencil"></i></a>
