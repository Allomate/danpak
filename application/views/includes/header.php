...
<head>
	...
	<link href="<?= base_url('assets/vendors/bower_components/dropify/dist/css/dropify.min.css'); ?>" rel="stylesheet"
	 type="text/css" />
	...
	<link href="<?= base_url('assets/css/style.css?v=1.1.2'); ?>" rel="stylesheet" type="text/css" />
	<link href="<?= base_url('assets/dist/css/style.css?v=2.4'); ?>" rel="stylesheet" type="text/css" />
