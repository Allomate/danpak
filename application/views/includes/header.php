...
<head>
	...
	<link href="<?= base_url('assets/vendors/bower_components/jquery.steps/demo/css/jquery.steps.css'); ?>" rel="stylesheet" type="text/css"/>
	...
	<link href="<?= base_url('assets/css/style.css?v=1.0'); ?>" rel="stylesheet" type="text/css"/>
	<link href="<?= base_url('assets/dist/css/style.css?v=1.0'); ?>" rel="stylesheet" type="text/css"/>
</head>
<body>