										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-dark block counter"><?= $Orders["stats"]["Total"]; ?></span>
								...
								<div class="panel-body pa-0">
									<div class="sm-data-box">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-dark block counter"><?= $Orders["stats"]["Cancelled"]; ?></span>
								...
								<div class="panel-body pa-0">
									<div class="sm-data-box">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-dark block counter"><?= $Orders["stats"]["Pending"]; ?></span>
								...
								<div class="panel-body pa-0">
									<div class="sm-data-box">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-dark block counter"><?= $Orders["stats"]["Completed"]; ?></span>
								...
								<div class="panel-body pa-0">
									<div class="sm-data-box">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-dark block counter"><?= $Orders["stats"]["Compliance"]; ?></span>
								...
								<div class="panel-body pa-0">
									<div class="sm-data-box">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-dark block counter"><?= $Orders["stats"]["NonCompliance"]; ?></span>
									...
									<tbody>
										<?php foreach ($Orders["orderDetails"] as $order) : ?>
											<tr>
												...
												<td><?= $order->within_radius ? "Yes" : "No"; ?></td>
												<td><?= $order->status ? $order->status : "Pending"; ?></td>
												<td>
													<?php if($this->uri->segment(3) !== "EmployeesList") : ?>
														<?php if ($order->status == "Processed") : ?>
															<a href="<?= base_url('Orders/UpdateOrder/'.$order->id); ?>"><i class="fa fa-pencil"></i></a>
