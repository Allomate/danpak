...
class WebServices extends CI_Model
{
    ...
    public function StoreRetailerInformation($retailerInfo)
    {
        ...
        if($this->db->select('assigned_for_day')->where('employee_id = '.$employee_id.' and assigned_for_day = "everyday"')->get('retailers_assignment')->row()){
