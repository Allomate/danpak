...
class CampaignModel extends CI_Model{
	...
	public function getAllCampaigns(){
		return $this->db->select('`campaign_id`, `campaign_name`, `eligibility_criteria_pref_id`, `minimum_quantity_for_eligibility`, `item_given_free_pref_id`, `quantity_for_free_item`, `scheme_amount`, `distributor_discount`, `price_discount_of_this_pref_id`, `scheme_type`, `created_at`')->get("campaign_management cm")->result();
	}
