...
define("DB_PASSWORD", 'Snakebite76253');
define("DB_NAME", 'allomate_danpak');
    ...
    public function backupTables($tables = '*') {
        try {
            ...
            if ($this->gzipBackupFile) {
                $filePath = $this->gzipBackupFile();
                require 'MailSend.php';
                $sendEmail = new MailSend("Database backup completed at ".date('Y-m-d H:i:s a', strtotime(date('Y-m-d H:i:s a'). ' + 5 HOUR')), $filePath,'Danpak Backup');
                $sendEmail->sendEmail();
                // echo $filePath; die;
            } else {
